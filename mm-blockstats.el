		...
		(setq loc-resultsymbol (intern (concat "EclipseMC-" (format "%05x" loc-coinbaseversion)))))
	       ((string-match "/ViaBTC/" loc-resultstring)
               ...
               ((string-match "/prohashing.com" loc-resultstring)
                (setq loc-resultsymbol (intern (concat "Purportedly prohashing.com-" (format "%05x" loc-coinbaseversion)))))
               ((string-match "/www.okpool.top/" loc-resultstring)
                (setq loc-resultsymbol (intern (concat "Purportedly www.okpool.top-" (format "%05x" loc-coinbaseversion)))))
